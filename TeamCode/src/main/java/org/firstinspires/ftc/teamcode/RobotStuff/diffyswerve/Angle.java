...
public class Angle {
    ...
    public Angle forward () {
        return FORWARD.rotateBy(BACKWARD.getAngle()).rotateBy(LEFT.getAngle());
    }
...
//    }
    ...
    public static AngleType numericalAndCoordinate(AngleType numericalType, AngleType coordinateType) {
        if (isZeroTo360(numericalType) && isCartesian(coordinateType))
            ...
            return AngleType.NEG_180_TO_180_HEADING; //!isZeroTo360(numericalType) && !isCartesian(coordinateType)
    }
